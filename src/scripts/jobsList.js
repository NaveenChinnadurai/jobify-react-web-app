...
import icon6 from '../assets/icons/nike.png'
export const jobList=[
    {
        img:icon1,
        jobTitle:'Product Manager',
        company:'Umbrella Infotech pvt Ltd',
        type:'Job',
        level:'senior',
        location:'coimbator',
        time:'Full-Time',
    ...
    {
        img:icon4,
        jobTitle:'Promt Engineer',
        company:'Freshworks software Pvt Ltd',
        type:'Internsip',
        level:'fresher/senior',
        location:'Online',
        time:'Virtual',
        postedOn:'14 hrs ago',
    },
    {
        img:icon5,
        jobTitle:'Digital Maketing Team Lead',
        company:'HCL Pvt Ltd',
        type:'Job',
        level:'Senior',
        location:'coimbator',
